...
for _ in range(cars):
    in_out, car_numbers = input("Enter IN/OUT and car number separated by comma: ").split(',')#ту проверяваме дали има нещо в cars и със split си разделяме колите на вход изход и номер и се активира 
